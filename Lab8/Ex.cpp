...
#include <time.h>
using namespace std;
int value = 0, count = 0, stateValue = 0, temp = 0;
char userInput;
char stateVal;
bool enabledStatus;
bool countingDown;
...
int main( int argc, char ** argv ){
	...
	pthread_t tid_reader, tid_evenChecker, tid_countDownThread; // Thread ID's
	pthread_attr_t attr;
...
void *inputReader( void *param ){
	...
	pthread_exit( 0 ); // This is how our thread exits
